          ...
          Stack(
            children: [
              ...
              Align(
                ...
                child: IconButton(
                  onPressed: () => favoriteBloc.add(FavoriteRemoveItemEvent(eletronicDataModel: eletronicDataModel)),
                  icon: Icon(Icons.delete_outlined, size: 20, color: AppColors.kPrimaryColor,)
                ),
              ),
            ],
          ),
